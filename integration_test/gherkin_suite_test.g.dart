        ...
        runScenario(
          ...
          steps: [
            ...
            (
              ...
              return await runStep(
                name: 'И Я указываю фамилию "Chibisova"',
                multiLineStrings: <String>[],
                table: null,
                dependencies: dependencies,
                skip: skip,
            ...
            (
              ...
              return await runStep(
                name: 'И Я указываю дату рождения "2001-12-26"',
                multiLineStrings: <String>[],
                table: null,
                dependencies: dependencies,
                skip: skip,
            ...
            (
              ...
              return await runStep(
                name: 'И Я указываю отчество "Olegovna"',
                multiLineStrings: <String>[],
                table: null,
                dependencies: dependencies,
                skip: skip,
